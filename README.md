...
<img align="right" width="300px" height="200px" src="./assets/slither.png">
...
Skills: Golang · PostgreSQL · Privy · Prisma ORM · Project Management

- Live: <a href="https://pvplabs.xyz">pvplabs.xyz</a>
- smart contract: <a href="https://github.com/asseph/pvplabs-payment-sc">pvplabs-payment-sc</a>

<h3><u><strong><i>Something</i></strong></u> &nbsp;- Solana Token Launchpad (IPOs)</h3>
<hr />

<img align="right" width="300px" height="200px" src="./assets/something.png">

Something Launchpad is the mysterious, high-velocity Solana-native token launchpad that's been quietly building hype across the degen trenches. Built for speed, fairness, and viral chaos, it lets anyone from anon memelords to serious builders deploy tokens in seconds without the usual headaches of liquidity setup, rugs, or insane fees.Forget outdated presales and whale-dominated IDOs. 

Something flips the script with next-level mechanics designed for the 2026 Solana meta: ultra-fast one-click launches, integrated bonding curves (or equivalent dynamic pricing), automatic liquidity bootstrapping, and seamless ties to Solana's top DEXs like Raydium and Jupiter.

Skills: Smart Contract · Bonding curve · Launchpad · Rust · Anchor

- Live: <a href="https://something.tools">something.tools</a>
- smart contract: <a href="https://github.com/asseph/somethingdottools-solana-bondingcurve-sc">solana-bondingcurve-sc</a>

<h3><u><strong><i>ClickCreate</i></strong></u> &nbsp;- Solana Memecoin Trading toolkit</h3>
<hr />

<img align="right" width="300px" height="200px" src="./assets/clickcreate-app.png">

Click Create is the ultimate all-in-one Solana token powerhouse — a sleek, user-friendly multi-tool app that bundles everything you need to create, manage, and launch your SPL token in one seamless flow. No more juggling multiple sites, bots, or confusing dashboards. 

From idea to live on Pump.fun (or beyond), Click Create makes it stupid-simple for degens, creators, and builders to "click and ship" in seconds.Built for the fast-paced Solana meta, it strips away the friction so you can focus on cooking the next viral token instead of fighting tools.

Skills: Launchpad · Rust · Pump.fun · Raydium · MeteoraAG · Bundling · Snipping · Trading 

- repo: <a href="https://github.com/asseph/clickcreate-sol">ClickCreate</a>


<h3><u><strong><i>SEND FOMO</i></strong></u> &nbsp;- Solana NFT Minting Game via Blink</h3>
<hr />

<img align="right" width="300px" height="200px" src="./assets/send-blink.png">

SEND FOMO is perfect for degens, gamblers, meme-coin lovers, and anyone who thrives on high-risk, high-reward social games. It's not just an NFT mint — it's a live psychological battle where timing, guts, and a bit of luck determine who walks away with the bag.Website reference: sendfomo.com
Built around / tied to the $SEND token ecosystem.


Skills: Smart Contract · NFT · Rust · Anchor · Blink · AWS · MeteoraAG

- smart contract: <a href="https://github.com/asseph/send-fomo-sc">send-fomo-sc</a>

<h3><u><strong><i>The Rune Guardians</i></strong></u> &nbsp;- P2E Bitcoin Rune Token Mining Game</h3>
<hr />

<img align="right" width="300px" height="200px" src="./assets/rune-game.png">

Play-to-Earn game built on Bitcoin, designed to give users a rich mining experience while interacting with Rune and Ordinal assets. The project includes a complete marketplace for runes, rune etching and minting tools, claiming mechanisms, an ordinal-based raffle, and an integrated auction platform.

Skills: Project Management · Rust · Python (Programming Language) · Web3 Game · PostgreSQL

- Live: <a href="https://theruneguardians.com">theruneguardians.com</a>
